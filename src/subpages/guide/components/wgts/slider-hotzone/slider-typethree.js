...
export default class SliderTypeThree extends Component {
  static options = {
    addGlobalClass: true
  }
                  ...
                  {item.hotzoneData.map((h_item, index) => {
                    return (
                      <View
                        ...
                        style={`width: ${h_item.widthPer * 100}%; height: ${
                          h_item.heightPer * 100
                        }%; top: ${h_item.topPer * 100}%; left: ${h_item.leftPer * 100}%`}
