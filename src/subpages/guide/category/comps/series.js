...
export default class Series extends Component {
  ...
  render() {
    ...
    const items = info[currentIndex] ? info[currentIndex].children : []
    const id = info[currentIndex] ? info[currentIndex].id : ''
    const itemsImg = info[currentIndex] ? info[currentIndex].img : ''
