...
const initialConfigState = {
  ...
  navFilterList: [
    ...
    },
    {
      ...
      label: '分类',
      activeIndex: null,
      option: [{ category_name: '全部', category_id: 'all' },{ category_name: '男装', category_id: '1',children:[{ category_name: '上衣', category_id: '3' ,children:[{ category_name: '卫衣', category_id: '4' }]}] },{ category_name: '女装', category_id: '2' }]
    },
    {
      key: 'status',
      label: '状态',
...
const SelectShop = () => {
  ...
  const { searchConditionList ,codeStatus,navFilterList,tag_id,category,status} = state
