...
const Index = (props) => {
  ...
  const {selectArea,searchValue,searchCondition,isSpAddressOpened,searchConditionVis,searchConditionList } = state
  ...
  const handleConditionChange = (value) => {
    setState((draft) => {
      draft.searchCondition = value,
      draft.searchConditionVis = false,
      draft.searchValue = ''
    })
  }
