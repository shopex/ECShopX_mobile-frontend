...
// 图片引入
import ErrorDaDa from '../../subpage/assets/dada0.png'
import WaitStore from '../../subpage/assets/dada1.png'
import WaitDaDa from '../../subpage/assets/dada2.png'
import OnRoad from '../../subpage/assets/dada4.png'
import Cancel from '../../subpage/assets/dada5.png'
import Success from '../../subpage/assets/dada6.png'
import DadaGoStore from '../../subpage/assets/dada7.png'
...
`
  ...
  async handleClickBtn(type, e) {
    ...
    const { info } = this.state
    if (type === 'home') {
      // console.log(this.isPointitemGood(),';;;;this.isPointitemGood()')
    ...
    if (type === 'cancel') {
      Taro.navigateTo({
        url: `/subpages/salesman/cancel?order_id=${info.tid}`
      })
      return
    }
