...
export default class make_comment extends Component {
  constructor (props) {
    super(props)
    this.state = {
      ...this.state,
              ...
              <View className="comment_list__scroll_scrolls">
                    {
                        list.map(item => {
                            return (
                              <View className="comment_list__scroll_scrolls_item"
                              onClick={this.topages.bind(this,`/mdugc/pages/make_details/index?item_id=${item.post_id}`)}
                              >
                                  <View className='comment_list__scroll_scrolls_item_l'>
                                    <Image className='comment_list__scroll_scrolls_item_l_img' mode='aspectFill' src={item.from_userInfo.avatar} />
                                  </View>
                                  <View className='comment_list__scroll_scrolls_item_cen'>
                                    ...
                                    <View className='comment_list__scroll_scrolls_item_cen_text'>
                                      ...
                                      <View className='comment_list__scroll_scrolls_item_cen_text_time'>{item.time}</View>
                                    </View>
                                  </View>
                                  <View className='comment_list__scroll_scrolls_item_r'>
                                    <Image className='comment_list__scroll_scrolls_item_r_img' mode='aspectFill' src={item.postInfo.cover} />
                                  </View>
                              </View>
                                )
                        })
