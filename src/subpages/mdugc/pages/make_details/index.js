    ...
    return (
      <View className='ugcdetailsr'>
          ...
          <View className='ugcdetailsr_scroll_view'>
            ...
            <View className='ugcdetailsr_text'>
              <View className='ugcdetailsr_text_top'>
                ...
                {!isoneself ? (
                  <View
                    onClick={this.followercreate.bind(this)}
                    className={`ugcdetailsr_text_top_r ${
              ...
              <View className='ugcdetailsr_text_subject'>
                {topics?.map((item) => {
                  return (
                    <View
                      onClick={this.wordlist.bind(this, item)}
                      className='ugcdetailsr_text_subject_i'
                    >
                      {item.topic_name}
                    </View>
                  )
              ...
              <View className='ugcdetailsr_text_time'>{this.formatDate(file_details.created)}</View>
            </View>
            {goods?.length > 0 ? (
                            ...
                            <View className='ugcdetailsr_theory_i_r'>
                              <View className='ugcdetailsr_theory_i_r_t'>
                                ...
                                <View className='ugcdetailsr_theory_i_r_t_fabulous'>
                                  <View
                                    onClick={this.commentlike.bind(this, item.comment_id)}
                                    className={`${
                                    ...
                                    <View className='ugcdetailsr_theory_i_r'>
                                      <View className='ugcdetailsr_theory_i_r_t'>
                                        <View className='ugcdetailsr_theory_i_r_t_text'>
                                          ...
                                          <View
                                            className='ugcdetailsr_theory_i_r_t_text_word'
                                            onClick={this.onopen.bind(this, item, childi)}
                                          >
                                            <View className='ugcdetailsr_theory_i_r_t_text_word_title'>
                                        ...
                                        <View className='ugcdetailsr_theory_i_r_t_fabulous'>
                                          <View
                                            onClick={this.commentlike.bind(this, childi.comment_id)}
                                            className={`${
                                              childi.like_status
                                                ? 'icon-aixin-shixin'
                                                : 'icon-aixin'
        ...
        <View className='ugcdetailsr_footer'>
          ...
          <View className='ugcdetailsr_footer_icon'>
            <View
              onClick={this.postfavorite.bind(this)}
