...
export default class mdugcmember extends Component {
  ...
  render () {
    const { tab , list , page , oddList , evenList , curTagId , showBackToTop , scrollTop , isPopups , popnum , userinfo} = this.state
      ...
      <View className="ugcmember">
        ...
        <AtTabs
          ...
          >
            ...
            <AtTabsPane current={curTagId} index={1}>

            </AtTabsPane>
            <AtTabsPane current={curTagId} index={2}>
