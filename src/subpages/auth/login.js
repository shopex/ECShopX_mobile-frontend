...
function AuthLogin() {
  ...
  const { info, imgInfo, loginType } = state
  
  useEffect( () => {
    
  }, [])

  const fetchImageVcode = async () => {
  ...
  return (
    <SpPage className='page-auth-login'>
        ...
        <AtForm className='form'>
          <View className='form-field'>
            <AtInput
              ...
              onChange={handleInputChange.bind(this, 'mobile')}
            />
          </View>
          {/* 密码登录 */}
          {loginType == 1 && (
            ...
            <View className='form-field'>
              <View className='input-field'>
                <AtInput
                  ...
                  onChange={handleInputChange.bind(this, 'yzm')}
                />
              </View>
              <View className='btn-field'>
                {imgInfo && (
                  <Image
                    ...
                    onClick={getImageVcode.bind(this)}
                  />
                )}
              </View>
            </View>
          ...
          <View className='btn-text-group'>
            <Text className='btn-text' onClick={handleToggleLogin}>
          ...
          <View className='form-submit'>
            <AtButton circle type='primary' onClick={handleSubmit}>
              登录
            </AtButton>
          </View>
        </AtForm>
