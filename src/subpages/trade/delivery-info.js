  ...
  return <SpPage className="page-trade-delivery-info">
    <ScrollView scrollY className="scroll-view-container">
      <View className="view-container">
        {
          packageList.length > 0 && <View className="block-container">
            <ScrollView scrollX className="package-scroll" >
              {
                packageList.map((item, index) => (
                  <View className={classNames("package-item-wrap", {
                    ...
                    <View className="package-info-wrap">
                      ...
                      </View>
                      {
                        item.items.map(goods => (
                          <SpImage src={goods.pic} width={80} height={80} circle={8} mode="aspectFit" />
                        ))
                      }
                    </View>
                  </View>
...

        {
          deliverPointList.length > 0 && <View className="block-container">
            <View className="deliver-point-list">
              {
                deliverPointList.map(item => (
                  <View className="deliver-point-item">
