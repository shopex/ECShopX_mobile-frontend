...
const Login = () => {
    ...
    const phonePrefix = (value) => {
        if (value) {
            ...
            return <SpImage src="phone_icon.png" className="phone-icon" />
        }
    }
    ...
    const tcodePrefix = (value) => {
        if (value) {
            ...
            return <SpImage src="tcode_icon.png" className="tcode-icon" />
        }
    }
    ...
    const codePrefix = (value) => {
        if (value) {
            ...
            return <SpImage src="vcode_icon.png" className="code-icon" />
        }
    }
    ...
    const tcodeSuffix = <SpImage src={imgCodeInfo.imageData} className='tcode-img' onClick={handleClickImageCode} />
        ...
        <SpPage className={classNames('page-merchant-login')} needNavbar={false}>
            ...
            <View className={'page-merchant-login-content'}>
                ...
                <MInput
                    ...
                    suffix={codeSuffix}
                />
                <MButton className={classNames('mt-52', 'login-button')} onClick={handleLogin}>登录/入驻</MButton>
