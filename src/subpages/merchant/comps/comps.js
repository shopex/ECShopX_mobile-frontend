...
const Cell = (props) => {
    ...
    const renderInputContent = mode === 'input' && <View className='comps-cell_input'>
        <Input className='input' placeholder={placeholder} placeholderClass='placeholder-class' value={value} onInput={handleInput} />
    </View>;
    const renderAreaContent = mode === 'area' && <Picker
        mode='multiSelector'
        range={areaList}
        onChange={onChange}
...
const NavBar = (props) => {
    ...
    return (
        <View className='comps-nav-bar'>
            <View className='left'>
                {canBack && <View className='left-button' onClick={onBack}>
            ...
            <View className='right'>
                {canLogout && <View className='right-button' onClick={handleLogout}>
