    ...
    return (
      <View className="activity-zone">
        <View className="activity-zone__title">
          ...
          <View className="activity-zone__subtitle" onClick={this.handleClickActivity.bind(this,data[0].id)} >{base.subtitle}</View>
        ...
        <View className='scroll-list'>
          ...
          {data[0]&&data[0].goodslist.length>8&&<View className='ac_btn'>
