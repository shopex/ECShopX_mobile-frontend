...
export default class MemberIndex extends Component {
  ...
  fetchCouponCardList() {
    api.vip.getShowCardPackage({ receive_type: 'grade' }).then(({ all_card_list }) => {
      ...
      <View className='page-member-index' style={getThemeStyle()}>
        ...
        {(vipgrade.is_open || (!vipgrade.is_open && vipgrade.is_vip)) && memberDiscount !== '' && (
          ...
          >
            ...
            {vipgrade.is_vip && (
              <Image className='member-info-bg' src={vipgrade.background_pic_url} mode='widthFix' />
            )}
            {vipgrade.is_open && !vipgrade.is_vip && (
              <Image
            ...
            >
              <View className='view-flex-item'>
                ...
                <View className='member-trade__ziti-desc'>
                  您有
                  <Text className='mark'>{orderCount.normal_payed_daiziti || 0}</Text>
                  个等待自提的订单
                </View>
              </View>
        ...
        <View className='page-member-section'>
          {memberData.is_open_popularize && isWeixin && (
            <SpCell
              ...
              onClick={() => this.handleClickWxOAuth(this.beDistributor.bind(this))}
            ></SpCell>
          )}
            ...
            <View>
              {menuSetting.community_order && (
                <SpCell
                  ...
                  onClick={() =>
                    this.handleClickWxOAuth(
                      this.navigateTo.bind(this, '/groupBy/pages/orderList/index')
                    )
                  }
                ></SpCell>
              )}
            ...
            <View>
              {menuSetting.boost_activity && (
                <SpCell
                  ...
                  img={require('../../assets/imgs/group.png')}
                  onClick={() =>
                    this.handleClickWxOAuth(this.navigateTo.bind(this, '/boost/pages/home/index'))
                  }
                ></SpCell>
              )}
              {menuSetting.boost_order && (
                <SpCell
                  ...
                  img={require('../../assets/imgs/group.png')}
                  onClick={() =>
                    this.handleClickWxOAuth(this.navigateTo.bind(this, '/boost/pages/order/index'))
                  }
                ></SpCell>
              )}
            </View>
          ...
          {menuSetting.offline_order && (
            <SpCell
              ...
              img={require('../../assets/imgs/group.png')}
              onClick={() =>
                this.handleClickWxOAuth(this.navigateTo.bind(this, '/others/pages/bindOrder/index'))
              }
            ></SpCell>
          )}
          {/* {menuSetting.complaint && (
            <SpCell
              ...
              onClick={() =>
                this.handleClickWxOAuth(
                  this.navigateTo.bind(this, '/marketing/pages/member/complaint-record')
                )
              }
            ></SpCell>
          )} */}
          {menuSetting.activity && (
            <SpCell
              ...
              onClick={() =>
                this.handleClickWxOAuth(
                  this.navigateTo.bind(this, '/marketing/pages/member/item-activity')
                )
              }
            ></SpCell>
          )}
          {score_menu_open && (
            <SpCell
              ...
              onClick={() =>
                this.handleClickWxOAuth(this.navigateTo.bind(this, '/pointitem/pages/list'))
              }
            ></SpCell>
          )}
          {/* {
