...
import S from "@/spx";
import { WgtSlider, WgtImgHotZone, WgtMarquees, WgtNavigation, WgtCoupon, WgtGoodsScroll, WgtGoodsGrid, WgtShowcase, WgtSearchHome } from '../home/wgts'
  ...
  constructor (props) {
    ...
    this.state = {
      ...
      tabList: [
        ...
        { title: '商品列表', iconType: 'category', iconPrefixClass: 'icon', url: '/others/pages/store/list' },
