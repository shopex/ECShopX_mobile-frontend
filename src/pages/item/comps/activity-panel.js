                ...
                <View key={item.marketing_id} className='goods-sec-specs__activity-item'>
                  ...
                  <View className='goods-sec-specs__activity-header'>
                    ...
                    {item.promotion_tag === '加价购' && (
                      <View
                        className='goods-sec-specs__activity-header-icon at-icon at-icon-chevron-right'
                        onClick={this.handlePlusprice.bind(this, item.marketing_id)}
                      ></View>
                    )}
                  </View>
                  {item.plusitems && (
                    <View className='promotion-rule-goods'>
                      ...
                      <View
                        className='promotion-rule-goods__more'
                        onClick={this.handlePlusprice.bind(this, item.marketing_id)}
                      >
                        更多
                        <Text className='goods-sec-specs__activity-header-icon at-icon at-icon-chevron-right'></Text>
                      </View>
                    </View>
                  )}
