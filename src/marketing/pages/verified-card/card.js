                    ...
                    >
                        ...
                        <View className='bt'>
                            {/* <AtInput
                                ...
                                /> */}
                            <Picker mode='selector' range={bankData} rangeKey='bank_name' onChange={this.handleChange.bind(this)}>
                                <View className='picker'>
                                    <View className='picker__title'>银行</View>
                                    <Text
                                        className={classNames(info.bank_id ? 'pick-value' : 'pick-value-null')}
                                    >{info.bank_name ? info.bank_name : `请选择`}</Text>
                                </View>
                            </Picker>
                        </View>
