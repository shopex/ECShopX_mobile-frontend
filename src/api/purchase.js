...
export function getEmployeeActivityList(params) {
  // 获取可参与的活动列表
...
export function getEmployeeInviteCode(params) {
  // 获取员工邀请码
  return req.get('/employee/invitecode', params)
}

export function getEmployeeRelativeBind(params) {
  // 绑定成为亲友
  return req.post('/employee/relative/bind', params)
}

export function getUserEnterprises(params) {
  // 获取用户所在企业列表
  return req.get('/user/enterprises', params)
}

export function getEmployeeIsOpen() {
  // 是否开启内购
  return req.get('/employeepurchase/is_open')
}

export function getEmployeeActivitydata(params) {
  // 获取员工活动数据
...
export function getPurchaseActivityItems(params) {
  // 获取活动商品列表
  return req.get('/employeepurchase/activity/items', params)
}

export function getPurchaseDetail(item_id, params) {
  // 获取活动商品详情
  return req.get(`/employeepurchase/activity/item/${item_id}`, params)
}

export function getPurchaseCart(params) {
  // 获取内购购物车
  return req.get('/employeepurchase/cart', params)
}

export function updatePurchaseCart(params) {
  // 内购购物车更新
  return req.put('/employeepurchase/cart', params)
}

export function addPurchaseCart(params) {
  // 内购购物车新增
  return req.post('/employeepurchase/cart', params)
}

export function deletePurchaseCart(params) {
  // 内购购物车删除
  return req.delete('/employeepurchase/cart', params)
}

export function updatePurchaseCartcount(params) {
  // 内购购物车数量
