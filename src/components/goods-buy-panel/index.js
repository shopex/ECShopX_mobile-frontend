  ...
  render() {
    ...
    if (isPackage === 'package') {
      ...
      if (curSkus) {
        ...
        marketPrice =
          (packItem[curSkus.item_id] && packItem[curSkus.item_id].market_price) ||
          (mainpackItem[curSkus.item_id] && mainpackItem[curSkus.item_id].market_price)
      } else {
        price = info.price * 100
        marketPrice = info.market_price * 100
      }
        ...
        <View className='goods-buy-panel__wrap'>
          ...
          <View className='goods-buy-panel__ft'>
            <View className='goods-buy-panel__btns'>
              {type === 'cart' &&
                hasStore &&
                (!curSkus || (curSkus && curSkus.approve_status === 'onsale')) && (
                  <View onClick={this.handleBuyClick.bind(this, 'cart', curSkus, quantity)}>
                    <Button
                      loading={busy}
              ...
              {type === 'fastbuy' &&
                hasStore &&
                (!curSkus || (curSkus && curSkus.approve_status === 'onsale')) && (
                  <View onClick={this.handleBuyClick.bind(this, 'fastbuy', curSkus, quantity)}>
                    <Button
                      loading={busy}
