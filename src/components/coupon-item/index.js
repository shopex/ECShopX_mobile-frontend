    ...
    return (
      ...
      >
        ...
        <View className={`detail ${isExpanded && 'show'} `}> 
          ...
          { info.use_bound!=='0' && info.use_bound=='1' && <View>{'此优惠券只适合指定商品使用'}</View>}
          { info.use_bound!=='0' && (info.use_bound=='2' || info.use_bound=='3') && <View>{'此优惠券只适合指定分类商品使用'}</View>}
          { info.use_bound!=='0' && info.use_bound=='4' && <View>{'此优惠券只适合指定品牌商品使用'}</View>}
        </View> 
