          ...
          <View className="goods-item__cont">
            ...
            <View className="goods-item__caption">
                    ...
                    <Text
                      ...
                      className={`tagitem ${
                        ...
                        item.tag_type === "normal"
                          ...
                          : "goods-item__tag"
                      } ${item.tag_type === "member_preference" &&
                        "member_preference"}`}
                      style={
                        item.tag_type === "single_group" ||
                        item.tag_type === "limited_time_sale" ||
              ...
              <View onClick={onClick}>
                <Text
                  className={`goods-item__title ${isShow &&
                    "goods-item__gray"}`}
                >
                  {info.title}
                </Text>
                <Text
                  className={`goods-item__desc ${isShow && "goods-item__gray"}`}
                >
                  {info.desc || ""}
                </Text>
            ...
            <View className="goods-item__extra">
              ...
              {!isPointitem && (
                <View className="goods-item__price">
                  <View
                    className={`package-price ${isShow && "goods-item__gray"}`}
                  >
                    <Text
                      className={`goods-item__cur ${isShow &&
                        "goods-item__gray"}`}
                    >
                      ¥
                    </Text>
                    <Text>
                      {price}
                      {info.type === "1" && (
                        <Text className="taxText">（含税）</Text>
                      )}
                    </Text>
                  </View>
                  {Boolean(+marketPrice) && (
              ...
              {showFav && (
                <View className="goods-item__actions">
                  {type === "item" && (
                    <View
                      className={`${
                        info.is_fav ? "icon-star-on" : "icon-star"
                      }`}
                      onClick={this.handleFavClick}
                      style={
                        info.is_fav ? { color: colors.data[0].primary } : {}
                      }
                    />
                  )}
                  {type === "recommend" && (
