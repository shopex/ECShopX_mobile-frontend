...
var Recharge = (0, _index3.withPager)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  function Recharge() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Recharge.__proto__ || Object.getPrototypeOf(Recharge)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["curTabIdx", "tabList", "list", "page", "totalDeposit", "isLoading"], _this.handleClickTab = function (idx) {
  ...
  _createClass(Recharge, [{
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(params) {
        var _state, tabList, curTabIdx, _ref3, deposit, _ref4, list, total, nList;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return _index6.default.member.depositTotal();

              case 5:
                _ref3 = _context.sent;
                deposit = _ref3.deposit;
                _context.next = 9;
                return _index6.default.member.depositList(params);
              ...
              case 9:
                ...
                nList = (0, _index4.pickBy)(list, {
                  tradeType: 'tradeType',
                  detail: 'detail',
                  timeStart: function timeStart(_ref5) {
                    var _timeStart = _ref5.timeStart;
                    return (0, _index4.formatDataTime)(_timeStart * 1000);
                  },
                  money: function money(_ref6) {
                    var _money = _ref6.money;
                    return (_money / 100).toFixed(2);
                  }
                });
    ...
    value: function _createData() {
      ...
      var _state2 = this.__state,
          ...
          list = _state2.list,
          page = _state2.page,
          totalDeposit = _state2.totalDeposit;
