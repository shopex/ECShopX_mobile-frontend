...
var Login = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Login() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Login.__proto__ || Object.getPrototypeOf(Login)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "info", "isVisible", "urlBack"], _this.handleClickReg = function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                console.log(data, 19);
                _context.next = 9;
                return _index6.default.user.login(data).then(function (res) {
                  var urlBack = _this.state.urlBack;

                  _index4.default.setAuthToken(res.token);
                  console.log(res, 43);
  ...
  return Login;
}(_index.Component), _class.properties = {}, _class.$$events = ["handleClickReg", "handleSubmit", "handleErrorToastClose", "handleChange", "handleClickIconpwd", "handleClickForgtPwd"], _temp2);
