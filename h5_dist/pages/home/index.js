...
var HomeIndex = (_dec = (0, _index3.connect)(function (store) {
  ...
  function HomeIndex() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HomeIndex.__proto__ || Object.getPrototypeOf(HomeIndex)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["wgts", "store"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = 'http://pjj.aixue7.com/index.php/api/h5app/wxapp/pageparams/setting?template_name=yykweishop&version=v1.0.1&page_name=index';
                _context.next = 3;
