...
var Detail = (_dec = (0, _index3.connect)(function (_ref) {
  ...
  function Detail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Detail.__proto__ || Object.getPrototypeOf(Detail)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "loopArray0", "info", "scrollTop", "windowWidth", "imgs", "timer", "marketing", "isPromoter", "desc", "showBackToTop", "curImgIdx", "__fn_onAddCart", "__fn_onFastbuy"], _this.handleSwiperChange = function (e) {
      ...
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type) {
        var _this$state, marketing, info, url, hasToken;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                hasToken = !!_index9.default.getAuthToken();
              ...
              case 5:
                ...
                _this.__triggerPropsFn("onAddCart", [null].concat([info]));
                return _context.abrupt("return", _index2.default.navigateTo({
                  url: url
                }));
  ...
  _createClass(Detail, [{
    ...
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var id, info, desc, marketing, timer;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _index5.default.item.detail(id, { distributor_id: 16 });
