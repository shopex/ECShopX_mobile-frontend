...
var SearchBar = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(SearchBar, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = (0, _index3.classNames)('search-input', showSearchDailog ? 'search-input__focus' : null, isFixed ? 'search-input-fixed' : null);
...
}, _class.$$events = ["handleConfirm", "handleFocusSearchHistory", "handleChangeSearch", "handleClickCancel", "handleClickDelete", "handleClickTag"], _class.defaultProps = {
  isOpened: false
}, _class.options = {
  addGlobalClass: true
}, _temp2);
