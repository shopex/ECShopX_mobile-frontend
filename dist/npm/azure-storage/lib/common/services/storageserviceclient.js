...
var xml2js = require("../../../npm/xml2js/lib/xml2js.js");
var events = require("../../../../../events");
var _ = require("../../../npm/underscore/underscore.js");
var guid = require("../../../npm/uuid/index.js");
var os = require("../../../../../os");
var extend = require("../../../npm/extend/index.js");
var Parser = require("../../../npm/json-edm-parser/parser.js");
...
var WebResource = require("../http/webresource.js");
var BufferStream = require('../streams/bufferstream.js');

var ServiceSettings = require("./servicesettings.js");
var StorageServiceSettings = require("./storageservicesettings.js");
var Constants = require("../util/constants.js");
var StorageUtilities = require("../util/storageutilities.js");
var ServicePropertiesResult = require("../models/servicepropertiesresult.js");
var TableUtilities = require("../../services/table/tableutilities.js");

var SharedKey = require("../signing/sharedkey.js");
var SharedAccessSignature = require("../signing/sharedaccesssignature.js");
var TokenSigner = require("../signing/tokensigner.js");
...
var Logger = require("../diagnostics/logger.js");
        ...
        if (self._maximumExecutionTimeExceeded(Date.now(), options.operationExpiryTime)) {
                ...
                if (!isValid) {
                  ...
                  requestStream.on('end', function () {
                    if (errorMessageBuffer) {
                      ...
                      if (errorMessageBuffer.length > 3 && errorMessageBuffer[0] === 239 && errorMessageBuffer[1] === 187 && errorMessageBuffer[2] === 191) {
          ...
          if (body && body.inputStream) {
            ...
            var sendUnchunked = function () {
              var size = finalRequestOptions.headers['content-length'] ? finalRequestOptions.headers['content-length'] : Constants.BlobConstants.MAX_SINGLE_UPLOAD_BLOB_SIZE_IN_BYTES;
            ...
            var sendStream = function () {
              ...
              if (!azureutil.objectIsNull(finalRequestOptions.headers['content-length']) && finalRequestOptions.headers['content-length'] < 30408704) {
...
StorageServiceClient.prototype._buildRequestOptions = function (webResource, body, options, callback) {
  ...
  if (azureutil.isBrowser() && (webResource.method === Constants.HttpConstants.HttpVerbs.GET || webResource.method === Constants.HttpConstants.HttpVerbs.HEAD)) {
  ...
  if (validResponse && webResource.rawResponse) {
    ...
    if (validResponse && !rsp.error) {
      ...
      if (response.statusCode < 400 || response.statusCode >= 500) {
        this.logger.log(Logger.LogLevels.DEBUG, 'ERROR code = ' + response.statusCode + ' :\n' + util.inspect(rsp.body));
      }
...
StorageServiceClient.prototype.getAccountServiceProperties = function (optionsOrCallback, callback) {
  ...
  var webResource = WebResource.get().withQueryOption(QueryStringConstants.COMP, 'properties').withQueryOption(QueryStringConstants.RESTYPE, 'service');
...
StorageServiceClient.prototype.setAccountServiceProperties = function (serviceProperties, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.put().withQueryOption(QueryStringConstants.COMP, 'properties').withQueryOption(QueryStringConstants.RESTYPE, 'service').withHeader(HeaderConstants.CONTENT_TYPE, 'application/xml;charset="utf-8"').withHeader(HeaderConstants.CONTENT_LENGTH, Buffer.byteLength(servicePropertiesXml)).withBody(servicePropertiesXml);
