...
var BlobUtilities = require("./../../services/blob/blobutilities.js");
var FileUtilities = require("./../../services/file/fileutilities.js");
var azureutil = require("./util.js");
var SR = require("./sr.js");
var check = require("../../../npm/validator/index.js");
...
exports.blobTierNameIsValid = function (blobTier, callback) {
  ...
  if (!_.chain(_.union(_.values(BlobUtilities.BlobTier.PremiumPageBlobTier), _.values(BlobUtilities.BlobTier.StandardBlobTier))).map(function (val) {
    return val.toString().toUpperCase();
  }).contains(blobTier.toString().toUpperCase()).value()) {
...
exports.browserFileIsValid = function (browserFile, callback) {
  ...
  if (!azureutil.isBrowser() || !browserFile || !browserFile.constructor || !azureutil.isIE() && !browserFile.constructor.name || !azureutil.isIE() && browserFile.constructor.name !== 'File' && browserFile.constructor.name !== 'Blob' || !azureutil.objectIsInt(browserFile.size)) {
