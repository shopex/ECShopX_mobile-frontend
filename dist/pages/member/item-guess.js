...
var ItemGuess = (0, _index3.withPager)(_class = (0, _index3.withBackToTop)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  _inherits(ItemGuess, _BaseComponent);
  ...
  function ItemGuess() {
    ...
    _classCallCheck(this, ItemGuess);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ItemGuess.__proto__ || Object.getPrototypeOf(ItemGuess)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "scrollTop", "list", "page", "showBackToTop"], _this.handleClickItem = function (item) {
  ...
  _createClass(ItemGuess, [{
    key: "_constructor",
    value: function _constructor(props) {
      _get(ItemGuess.prototype.__proto__ || Object.getPrototypeOf(ItemGuess.prototype), "_constructor", this).call(this, props);
...
exports.default = ItemGuess;

Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(ItemGuess, true));