...
var Coupon = (0, _index5.withPager)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  function Coupon() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Coupon.__proto__ || Object.getPrototypeOf(Coupon)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["curTabIdx", "tabList", "list", "page", "curId"], _this.handleClickTab = function (idx) {
  ...
  _createClass(Coupon, [{
    ...
    value: function _constructor(props) {
      ...
      this.state = _extends({}, this.state, {
        curTabIdx: 0,
        tabList: [{ title: '可用优惠券', status: '1' }, { title: '过期和已使用', status: '2' }],
        list: [],
        curId: null
      });
    }
