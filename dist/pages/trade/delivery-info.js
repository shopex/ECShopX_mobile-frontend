...
var TradeDetail = (_temp2 = _class = function (_BaseComponent) {
  ...
  function TradeDetail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TradeDetail.__proto__ || Object.getPrototypeOf(TradeDetail)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["lists", "list"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(TradeDetail, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _index5.default.trade.deliveryInfo(this.$router.params.order_id);
              ...
              case 3:
                ...
                nList = (0, _index3.pickBy)(list, {
                  ...
                  content: function content(_ref3) {
                    var opeRemark = _ref3.opeRemark,
                        opeTitle = _ref3.opeTitle;
                    return [opeTitle, opeRemark];
                  }
                });
    ...
    value: function _createData() {
      ...
      // }
      var lists = [{ title: '刷牙洗脸' }, { title: '吃早餐' }, { title: '上班' }, { title: '睡觉' }];
