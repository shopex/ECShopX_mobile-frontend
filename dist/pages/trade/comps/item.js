...
}, _class.$$events = ["funPrivateVFHJd", "handleClickBtn", "funPrivateeQpLw", "funPrivateMDljW"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
