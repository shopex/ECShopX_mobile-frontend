...
}, _class.$$events = ["funPrivateGGyWP", "handleClickBtn", "funPrivateNcqND", "funPrivateFkCyH"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
