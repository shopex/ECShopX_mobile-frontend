...
}, _class.$$events = ["funPrivateZEaIP", "handleClickBtn", "funPrivateusBLH", "funPrivateQBVBv"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
