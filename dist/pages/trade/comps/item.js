...
}, _class.$$events = ["funPrivatexhoQZ", "handleClickBtn", "funPrivatelmPlk", "funPrivateoNQeN"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
