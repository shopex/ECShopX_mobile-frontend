...
}, _class.$$events = ["funPrivateLyYKo", "handleClickBtn", "funPrivatejOciE", "funPrivateDjROA"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
