...
}, _class.$$events = ["funPrivatePbvrO", "handleClickBtn", "funPrivateNlEHP", "funPrivategLepB"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
