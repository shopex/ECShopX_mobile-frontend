...
}, _class.$$events = ["funPrivateoNldF", "handleClickBtn", "funPrivateUPZio", "funPrivatenarEW"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
