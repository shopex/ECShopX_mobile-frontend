...
}, _class.$$events = ["funPrivateEznPk", "handleClickBtn", "funPrivateuUtgn", "funPrivateQDefB"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
