...
}, _class.$$events = ["funPrivateDPfzX", "handleClickBtn", "funPrivateFIvqE", "funPrivateKsSCo"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
