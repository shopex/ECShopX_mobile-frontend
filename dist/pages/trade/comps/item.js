...
}, _class.$$events = ["funPrivatejeAfM", "handleClickBtn", "funPrivateEtZif", "funPrivatemxSnv"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
