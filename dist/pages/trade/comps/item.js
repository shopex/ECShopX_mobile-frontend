...
}, _class.$$events = ["funPrivateElDPT", "handleClickBtn", "funPrivatesAsKL", "funPrivateEncfW"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
