...
}, _class.$$events = ["funPrivateKFBoJ", "handleClickBtn", "funPrivateNIfUh", "funPrivateFtMuh"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
