...
var PointList = (0, _index3.withPager)(_class = (0, _index3.withBackToTop)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  function PointList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PointList.__proto__ || Object.getPrototypeOf(PointList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["scrollTop", "listType", "list", "page", "showBackToTop", "query"], _this.handleClickItem = function (item) {
      var url = "/pages/item/point-detail?id=" + item.item_id + "&is_point=true";
