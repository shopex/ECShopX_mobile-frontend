...
var List = (0, _index3.withPager)(_class = (0, _index3.withBackToTop)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  function List() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = List.__proto__ || Object.getPrototypeOf(List)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "curFilterIdx", "filterList", "scrollTop", "listType", "list", "page", "showBackToTop", "query"], _this.handleFilterChange = function (data) {
  ...
  return List;
}(_index.Component), _class2.properties = {}, _class2.$$events = ["handleFilterChange", "handleListTypeChange", "handleScroll", "nextPage", "anonymousFunc0", "scrollBackToTop"], _temp2)) || _class) || _class;
