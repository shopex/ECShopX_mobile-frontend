...
var PointDetail = (_dec = (0, _index3.connect)(function (_ref) {
  ...
  function PointDetail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = PointDetail.__proto__ || Object.getPrototypeOf(PointDetail)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "loopArray0", "info", "scrollTop", "windowWidth", "imgs", "timer", "marketing", "isPromoter", "desc", "showBackToTop", "curImgIdx", "__fn_onFastbuy"], _this.handleSwiperChange = function (e) {
