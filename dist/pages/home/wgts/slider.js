...
var WgtSlider = (_temp2 = _class = function (_BaseComponent) {
  ...
  function WgtSlider() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WgtSlider.__proto__ || Object.getPrototypeOf(WgtSlider)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp4", "anonymousState__temp7", "loopArray0", "loopArray1", "info", "base", "config", "data", "curIdx", "curContent"], _this.handleClickItem = _helper.linkPage, _this.handleSwiperChange = function (e) {
